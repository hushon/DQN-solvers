...
parser.add_argument("-e", "--environment", action="store", default="Acrobot-v1",
...
parser.add_argument("-p", "--path", default="./Acrobot-v1/my_dqn.ckpt",
...
num_outputs_list = [500, 200] # number of units in input layer and hidden layer
