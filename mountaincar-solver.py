...
num_outputs_list = [800, 800] # number of units in input layer and hidden layer
...
with tf.Session() as sess:
    ...
    while True:
        ...
        # kp_ratio = 0.000001
        # kin_energy = np.square(next_state[2]-next_state[0])+np.square(next_state[3]-next_state[1])
        # pot_energy = -next_state[2]*kp_ratio
        # energy = kin_energy + pot_energy
        # print(kin_energy, pot_energy, energy)
        # sleep(0.1)
        # y_val = rewards + continues * discount_rate * max_next_q_values + energy
        # y_val = rewards + continues * discount_rate * max_next_q_values - next_state[3]
